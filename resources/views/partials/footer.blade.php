    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-sm max-w-md">
                    A modern multi-tenant SaaS application built with Laravel. Manage form submissions,
                    users, and content with ease.
                </p>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('home') }}" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 text-sm transition">
                            Home
                        </a>
                    </li>
                    @auth
                    ...
                    @else
                        ...
                        <li>
                            <a href="{{ route('register') }}" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 text-sm transition">
                                Sign Up
                            </a>
                        </li>
                    @endauth
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="#" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 text-sm transition">
                            Privacy Policy
                        </a>
                    </li>
                    <li>
        ...
        <div class="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
            <p class="text-center text-sm text-gray-500 dark:text-gray-400">
                &copy; {{ date('Y') }} {{ config('app.name', 'BladeCMS') }}. All rights reserved.
            </p>
        </div>
    </div>
</footer>
